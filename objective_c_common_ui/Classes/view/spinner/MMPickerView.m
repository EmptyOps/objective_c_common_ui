...
-(void)initializePickerViewInView: (UIView *)view
  ...
  _pickerContainerView = [[UIView alloc] initWithFrame:CGRectMake(0.0, _pickerViewContainerView.bounds.size.height - 260.0, width, 260.0)];
  ...
  _pickerContainerView.backgroundColor = [UIColor colorWithRed:220 green:220 blue:220 alpha:0.8];
  ...
  [_pickerTopBarView setBackgroundColor:[UIColor lightGrayColor]];
  ...
  _pickerViewToolBar.items = @[flexibleSpace, backBarButtonItem];
  [backBarButtonItem setTintColor:[UIColor lightGrayColor]];
  ...
  //Add pickerView
  _pickerView = [[UIPickerView alloc] initWithFrame:CGRectMake(0.0, 44.0, width1 , 216.0)];
...
- (UIView *)pickerView:(UIPickerView *)pickerView
  ...
  if (customPickerView==nil) {
    ...
    CGRect frame = CGRectMake(0.0, 0.0, width1 , 44.0);
...
//    [customPickerView addSubview:patternImageView];
    ...
    CGRect labelFrame = CGRectMake(0.0, _yValueFromTop, width , 35); // 35 or 44
