...
/**
 The title color of the button represented as a UIColor. The default title color is whiteColor.
 */
...
/**
 The border color of the button represented as a UIColor. The default border color is whiteColor.
 */
