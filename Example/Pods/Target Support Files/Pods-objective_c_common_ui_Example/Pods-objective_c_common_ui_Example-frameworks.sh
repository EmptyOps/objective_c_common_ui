...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/objective_c_common_helpers/objective_c_common_helpers.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/objective_c_common_ui/objective_c_common_ui.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/objective_c_core_helpers/objective_c_core_helpers.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/objective_c_sqlite_helper/objective_c_sqlite_helper.framework"
fi
